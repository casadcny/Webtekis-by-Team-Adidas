...
CREATE TABLE `friends` (
  `f1` int(7) NOT NULL,
  `f2` int(7) NOT NULL,
  `status` enum('pending','accept','decline','blocked','unfriend') NOT NULL DEFAULT 'pending',
...
CREATE TABLE `posts` (
  ...
  `visibility` enum('public','private','only me') NOT NULL,
  `image` blob,
  PRIMARY KEY (`idposts`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-08-21 13:52:19
